...
from memory_layer_robust_scene import RobustLLMController, RobustAgenticMemorySystem
...
class RobustAdvancedMemAgent:
    ...
    def add_scene_memory(self, turns, time=None, scene_title=None):
        """Add one memory built from multiple turns (minimal scene-level constructor)."""
        self.memory_system.add_scene_note(turns, time=time, scene_title=scene_title)
